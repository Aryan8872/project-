...
back=Label(root,image=root_bg,height=1070,width=1845)
back.place(x=0,y=0)
...
bacg=Label(frame,image=frame_bg,height=640,width=600)
bacg.place(x=0,y=0)
...
un_ent=Entry(frame,font=("Helvetica 14 bold"),bg="gray11",highlightthickness=0,relief=FLAT,fg="#6b6a69")
...
email_ent=Entry(frame,font=("Helvetica 14 bold"),bg="gray11",highlightthickness=0,relief=FLAT,fg="#6b6a69")
...
passwd_ent=Entry(frame,font=("Helvetica 14 bold"),bg="gray11",highlightthickness=0,relief=FLAT,fg="#6b6a69")
...
re_passwd_entry=Entry(frame,font=("Helvetica 14 bold"),bg="gray11",highlightthickness=0,relief=FLAT,fg="#6b6a69")
...
phn_entry=Entry(frame,font=("Helvetica 14 bold"),bg="gray11",highlightthickness=0,relief=FLAT,fg="#6b6a69")
...
gender1=Checkbutton(frame,text="male",bg="gray11",font=("Helvetica 10 bold"),variable="male")
gender1.place(x=200,y=460)
gender2=Checkbutton(frame,text="female",fg="limegreen",bg="gray11",font=("Helvetica 10 bold"),variable="female")
gender2.place(x=280,y=460)
gender3=Checkbutton(frame,text="other",fg="blue2",bg="gray11",font=("Helvetica 10 bold"),variable="others")
...
register=Button(frame,text="REGISTER",fg="white",bg="limegreen",font=("Helvetica 15 bold"),activeforeground="limegreen",width=18,bd=0,cursor="hand2",command=add_rec)
